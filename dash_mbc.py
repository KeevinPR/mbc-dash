...
def create_algorithm_section():
    return html.Div([
        ...
        html.Div(className="card", children=[
            html.Div([
                html.H3("4. Algorithm Selection", style={'display': 'inline-block', 'marginRight': '10px', 'textAlign': 'center'}),
                dbc.Button(
                    html.I(className="fa fa-question-circle"),
        ...
        html.Div(className="card", children=[
            html.Div([
                html.H3("5. Global Parameters", style={'display': 'inline-block', 'marginRight': '10px', 'textAlign': 'center'}),
            ], style={"textAlign": "center", "position": "relative"}),
        ...
        html.Div(className="card", children=[
            html.Div([
                html.H3("6. Algorithm-Specific Parameters", style={'display': 'inline-block', 'marginRight': '10px', 'textAlign': 'center'}),
            ], style={"textAlign": "center", "position": "relative"}),
